...
class ModelAttribute(Enum):
    ...
    UNet_SNGAN_VAE= (DgmType.GAN_VAE,  "model.model.UnetGenerator","model.model.Discriminator",128,"model.model.VaeGan",5,"conv",["1","2"])
    UNet_SNGAN_VAE_fc= (DgmType.GAN_VAE,  "model.model.UnetGenerator","model.model.Discriminator",128,"model.model.VaeGan",5,"fc",["1","4"])
    UNet_SNGAN_VAE_cat= (DgmType.GAN_VAE,  "model.model.UnetGenerator","model.model.Discriminator",128,"model.model.VaeGan",5,"cat",["1","2"])
